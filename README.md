...
| 🎯 | **Cybersecurity Bootcamp** — Professional Intensive Training |
| 🌐 | **Web App Pentest** — Web Application Security Certification |
| 🐍 | **Python Advanced** — Advanced Python Programming Certificate |
| 🎓 | **Computer Science** — Undergraduate CS Student |
